...
declare class UploadThingError<TShape extends Json = {
    ...
    static fromResponse(response: Response): Promise<UploadThingError<string | number | boolean | JsonObject | JsonArray | null>>;
    static toObject(error: UploadThingError): {
        code: "BAD_REQUEST" | "NOT_FOUND" | "INTERNAL_SERVER_ERROR" | "INTERNAL_CLIENT_ERROR" | "URL_GENERATION_FAILED" | "UPLOAD_FAILED" | "MISSING_ENV" | "FILE_LIMIT_EXCEEDED";
        message: string;
        data: {
            message: string;
        } | undefined;
...
declare function getStatusCodeFromError(error: UploadThingError<any>): 500 | 400 | 404;
